    ...
    <>
      ...
      <PageContainer className="p-16 justify-center bg-[#1c1917]">
        <div className="text-center">
          <div className="uppercase tracking-[0.5em] text-[#a8a29e] mb-4">Focus Spécifique</div>
          <h2 className="text-6xl font-serif text-[#fef3c7] mb-8">{focusInfo.title}</h2>
          <p className="text-xl text-[#fbbf24] max-w-2xl mx-auto leading-relaxed">
      ...
      <PageContainer className="p-16">
        ...
        <div className="prose prose-lg text-[#d6d3d1]">
          <h3 className="text-xl font-bold text-[#fbbf24] mb-4">Votre Approche Fondamentale</h3>
          ...
          <div className="bg-[#292524] p-8 rounded-xl border-l-4 border-[#fbbf24] mt-8">
            <p className="whitespace-pre-wrap leading-relaxed italic text-[#fdfbf7]">
      ...
      <PageContainer className="p-16">
        ...
        <div className="prose prose-lg text-[#d6d3d1]">
          <h3 className="text-xl font-bold text-[#fbbf24] mb-4">Comment vous agissez concrètement</h3>
          <p className="whitespace-pre-wrap leading-relaxed">
      ...
      <PageContainer className="p-16">
        ...
        <div className="prose prose-lg text-[#d6d3d1]">
          <h3 className="text-xl font-bold text-[#fbbf24] mb-4">Ce qui vous nourrit vraiment</h3>
          <p className="whitespace-pre-wrap leading-relaxed">
      ...
      <PageContainer className="p-16">
        ...
        <div className="prose prose-lg text-[#d6d3d1]">
          <h3 className="text-xl font-bold text-[#fbbf24] mb-4">Stratégie pour cette année</h3>
          <p className="whitespace-pre-wrap leading-relaxed">
      ...
      {/* PAGE 29: BLOCAGES */}
      <PageContainer className="p-16 bg-[#292524] border-l-[12px] border-red-900">
        <h2 className="text-4xl font-serif text-red-400 mb-12">Les Blocages à Lever</h2>
        <div className="grid grid-cols-1 gap-8">
          <div className="bg-[#1c1917] p-8 rounded-lg shadow-sm border border-red-900/30">
      ...
      <PageContainer className="p-16 bg-[#292524] border-l-[12px] border-green-900">
        <h2 className="text-4xl font-serif text-green-400 mb-12">Les Clés de Passage</h2>
        <ul className="space-y-6">
          <li className="flex gap-4 items-start">
            <div className="w-8 h-8 rounded-full bg-green-900 text-green-200 flex items-center justify-center font-bold flex-shrink-0 border border-green-500">1</div>
            <p className="text-green-100/90 text-lg">Acceptez que le rythme de votre Année {results.personalYear} soit le bon rythme. Ne forcez pas.</p>
          </li>
          <li className="flex gap-4 items-start">
            <div className="w-8 h-8 rounded-full bg-green-900 text-green-200 flex items-center justify-center font-bold flex-shrink-0 border border-green-500">2</div>
            <p className="text-green-100/90 text-lg">Utilisez votre talent d'Expression {results.expression} pour communiquer clairement vos besoins.</p>
          </li>
          <li className="flex gap-4 items-start">
            <div className="w-8 h-8 rounded-full bg-green-900 text-green-200 flex items-center justify-center font-bold flex-shrink-0 border border-green-500">3</div>
            <p className="text-green-100/90 text-lg">Faites confiance à votre intuition (Moi Intime {results.personality}) pour guider vos choix.</p>
          </li>
        </ul>
      </PageContainer>
    </>
