    ...
    <>
      ...
      <PageContainer className="p-4 md:p-16 bg-[#FAF9F7]">
        <div className="text-center mb-8">
          <div className="uppercase tracking-[0.5em] text-[#8FA6A0] mb-2 text-sm">Focus Spécifique</div>
          <h2 className="text-3xl md:text-5xl font-serif text-[#2C2F4A]">{focusInfo.title}</h2>
        </div>

        <div className="space-y-6">
          {/* Life Path */}
          <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
            <h3 className="text-lg font-bold text-[#C9A24D] mb-2 flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-[#C9A24D] text-white flex items-center justify-center text-xs">1</span>
              L'Approche (Chemin de Vie {results.lifePath})
            </h3>
            <p className="text-[#2C2F4A] text-sm md:text-base leading-relaxed italic">
          ...
          <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
            <h3 className="text-lg font-bold text-[#C9A24D] mb-2 flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-[#C9A24D] text-white flex items-center justify-center text-xs">2</span>
          ...
          <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
            <h3 className="text-lg font-bold text-[#C9A24D] mb-2 flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-[#C9A24D] text-white flex items-center justify-center text-xs">3</span>
      ...
      <PageContainer className="p-4 md:p-16">
        <h2 className="text-2xl md:text-3xl font-serif text-[#2C2F4A] mb-8 border-b border-[#C9A24D] pb-4">
          Stratégie & Dépassement
        </h2>

        {/* Climate */}
        <div className="mb-8">
           <h3 className="text-lg font-bold text-[#C9A24D] mb-2">Le Climat Annuel (Année {results.personalYear})</h3>
           <div className="bg-white p-6 rounded-xl border-l-4 border-[#C9A24D] shadow-sm">
            <p className="text-[#2C2F4A] text-sm md:text-base italic">
              {pyContent}
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-green-700 mb-2">Les Clés de Réussite</h3>
             <div className="bg-green-50 p-4 rounded-lg border border-green-200 flex gap-3">
               ...
               <p className="text-[#2C2F4A] text-xs md:text-sm">Alignez votre rythme sur celui de votre Année Personnelle.</p>
             </div>
             <div className="bg-green-50 p-4 rounded-lg border border-green-200 flex gap-3">
               ...
               <p className="text-[#2C2F4A] text-xs md:text-sm">Exprimez clairement vos besoins (Expression {results.expression}).</p>
             </div>
             <div className="bg-green-50 p-4 rounded-lg border border-green-200 flex gap-3">
